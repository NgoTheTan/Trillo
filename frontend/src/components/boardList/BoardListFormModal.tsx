        ...
        <div>
            {
                isOpen ?
                    <form onSubmit={handleSubmit} className='border border-gray-300 p-3 bg-white rounded-xl shadow-lg space-y-3 w-70'>
                        <p className='font-bold text-sm text-gray-800'>New Column</p>
                        <input
                        ...
                        <div className='grid grid-cols-2 gap-2'>
                            ...
                            <Button type='submit' className='cursor-pointer text-white bg-blue-700 hover:bg-blue-800'>Add List</Button>
                        </div>
                    </form>
                    :
